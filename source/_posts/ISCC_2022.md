...
（本人只是一位大一的初学者，第一次进行scanf的源码调试（关于搭建源码调试环境的文章在这里  [here]([关于gdb源码调试环境搭建 - ZikH26 - 博客园 (cnblogs.com)](https://www.cnblogs.com/ZIKH26/articles/16150232.html))），如果上述有理解错误的地方，还请各位师傅斧正）
